...
analysisdir = "../analysis/A03.3-pcoa-first2-timept/"
...
searshsimmunotxpcoa(file="../analysis/A03.1-add-metadata/jhmi-esca-microbiota.beta-diversity.unweighted_unifrac.txt", prefix = "unweighted_unifrac")
searshsimmunotxpcoa(file="../analysis/A03.1-add-metadata/jhmi-esca-microbiota.beta-diversity.weighted_unifrac.txt",   prefix = "weighted_unifrac")
