...
# ---------------------------------------------------
# configure per user ---
setwd("/Users/seoholee/Dropbox/Johns Hopkins Medicine/Research/Microbiome Project/R")
analysisdir = "../R/diff-ab-first2-timept-tumor"
...
for (txlevel in taxalevels){
  ...
  dir.create(pdfdir)
  # ---------------------------------------------------
  tablefile = paste("/Users/seoholee/Dropbox/Johns Hopkins Medicine/Research/Microbiome Project/R/jhmi-esca-microbiota.", txlevel, ".xlsx", sep="")
  A         = read_excel(tablefile) 
  Awmeta    = A[1:21,]
  Awmeta <- subset(Awmeta, SampleType %in% c("Tissue_tumor"))
  ...
  colnames(Awmeta)[34:ncol(Awmeta)] = gsub("k_Bacteria.", "", colnames(Awmeta)[34:ncol(Awmeta)])
  colnames(Awmeta)[34:ncol(Awmeta)] = gsub(";", ".", colnames(Awmeta)[34:ncol(Awmeta)])
  colnames(Awmeta)[34:ncol(Awmeta)] = gsub(" ", "", colnames(Awmeta)[34:ncol(Awmeta)])
  colnames(Awmeta)[34:ncol(Awmeta)] = gsub("__", ".", colnames(Awmeta)[34:ncol(Awmeta)])
  # completed modifying colnames of taxa ---
  taxaFeatures = colnames(Awmeta)[34:ncol(Awmeta)] # this is the list we will visualize
