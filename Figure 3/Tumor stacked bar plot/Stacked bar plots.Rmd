...
```{r}
setwd("~/Dropbox/Johns Hopkins Medicine/Research/Microbiome Project/R")
files  = c("jhmi-esca-microbiota.phylum.xlsx",
           "jhmi-esca-microbiota.class.xlsx",
           "jhmi-esca-microbiota.order.xlsx",
           "jhmi-esca-microbiota.family.xlsx",
           "jhmi-esca-microbiota.genus.xlsx",
           "jhmi-esca-microbiota.species-otu.avgGTE0.01Pr.xlsx")
